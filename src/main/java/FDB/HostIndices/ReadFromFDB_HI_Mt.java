...
public class ReadFromFDB_HI_Mt {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (BufferedWriter outputFile = new BufferedWriter(new FileWriter("/Users/dazatyan/IdeaProjects/Training/src/main/java/FDB/HostIndices/hi-mt_data.txt"))) {
            System.out.println("Output file opened");


            byte[] rangeStartKey = {(byte) 0x02, 'h', 'i', (byte) 0x00, (byte) 0x01, (byte) 0x01, (byte) 0x00, (byte) 0x02, 'm', 't', (byte) 0x00};
            byte[] rangeEndKey = {(byte) 0x02, 'h', 'i', (byte) 0x00, (byte) 0x01, (byte) 0x01, (byte) 0x00, (byte) 0x02, 'm', 't', (byte) 0x00, (byte) 0xff};
