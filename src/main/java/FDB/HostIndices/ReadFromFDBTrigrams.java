...
public class ReadFromFDBTrigrams {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (BufferedWriter outputFile = new BufferedWriter(new FileWriter("/Users/dazatyan/IdeaProjects/Training/src/main/java/FDB/HostIndices/trigrams_data.txt"))) {
...
//            byte[] rangeEndKey = {(byte) 0x02, 'h', 'i', (byte) 0x00, (byte) 0x01,(byte)0x01,(byte)0x00, (byte) 0xff};
            ...
            byte[] rangeStartKey = {(byte) 0x02, 'h', 'i', (byte) 0x00, (byte) 0x01, (byte) 0x01, (byte) 0x00, (byte) 0x02, 't', 'r', 'i', 'g', 'r', 'a', 'm', (byte) 0x00};
            byte[] rangeEndKey = {(byte) 0x02, 'h', 'i', (byte) 0x00, (byte) 0x01, (byte) 0x01, (byte) 0x00, (byte) 0x02, 't', 'r', 'i', 'g', 'r', 'a', 'm', (byte) 0x00, (byte) 0xff};
...
//                        String keyStr = Tuple.fromBytes(key).toString();
                        String keyStr = KeySelector.firstGreaterOrEqual(key).toString();
//                        String valueStr = Tuple.fromBytes(value).toString();
                        long valueDecode = Longs.fromByteArray(value);
