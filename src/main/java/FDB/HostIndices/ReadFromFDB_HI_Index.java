...
public class ReadFromFDB_HI_Index {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (BufferedWriter outputFile = new BufferedWriter(new FileWriter("/Users/dazatyan/IdeaProjects/Training/src/main/java/FDB/HostIndices/hi-index_data.txt"))) {
...
//            byte[] rangeStartKey = {(byte) 0x02, 's', 'i', (byte) 0x00, (byte) 0x01, (byte) 0x01, (byte) 0x00, (byte) 0x02, 'i', 'n', 'd', 'e', 'x', (byte) 0x00};
//            byte[] rangeEndKey = {(byte) 0x02, 's', 'i', (byte) 0x00, (byte) 0x01, (byte) 0x01, (byte) 0x00, (byte) 0x02, 'i', 'n', 'd', 'e', 'x', (byte) 0x00, (byte) 0xff};
